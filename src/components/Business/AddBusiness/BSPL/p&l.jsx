...
const PANDL = () => {
    const [values, setValues] = useState({
        ...
        dividendIncome: 0,
        interestIncome: 0,
        profitOnSaleOfFixedAssets: 0,
        profitOnSaleOfSecurities: 0,
        profitOnSaleOfOtherInvestment: 0,
        gainOnForeignExchangeFluctuation: 0,
        profitOnConversionOfInventory: 0,
        agriculturalIncome: 0,
        otherIncomeNature: 0,
        otherIncomeAmount: 0,
        totalOtherIncome: 0,
        totalCreditsToPLAccount: 0,
        freightOutward: 0,
        consumptionOfStoresAndSpareParts: 0,
        powerAndFuel: 0,
        rents: 0,
        repairsToBuilding: 0,
        repairsToMachinery: 0,
        compensationToEmployees: 0,
        salariesAndWages: 0,
        bonus: 0,
        reimbursementOfMedicalExpenses: 0,
        leaveEncashment: 0,
        leaveTravelBenefits: 0,
        contributionToSuperannuationFund: 0,
        contributionToProvidentFund: 0,
        contributionToGratuityFund: 0,
        contributionToOtherFund: 0,
        otherBenefitToEmployees: 0,
        totalCompensationToEmployees: 0,
        compensationToNonResidents: 0,
        amountPaidToNonResidents: 0
    });
