...
const HousePropertyForm = ({ clientId, year }) => {
  ...
  const handleOwnerPropertyChange = (index, field, value) => {
    const updatedProperties = [...houseProperties];
    updatedProperties[index][field] = value;
    setHouseProperties(updatedProperties);
  };
  ...
  const addHouse = () => {
    setHouseProperties([...houseProperties, { PropertyType: "", PropertyOwner: "" }]);
                    ...
                    <div className="col-md-4">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={(e) => handleOwnerPropertyChange(index, "OwnerName", e.target.value)}
                        />
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={(e) => handleOwnerPropertyChange(index, "OwnerPAN", e.target.value)}
                        />
                      </div>
                    </div>
                    <div className="col-md-4">
